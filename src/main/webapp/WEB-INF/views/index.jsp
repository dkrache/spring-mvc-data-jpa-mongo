...
<link href='http://fonts.googleapis.com/css?family=Duru+Sans|Actor'
...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span class="blue">I</span> <span
					class="white">Am</span><span class="red">sterdam</span></a>
			</div>
			<nav role="navigation" class="collapse navbar-collapse navbar-right">
				<ul class="navbar-nav nav">
					...
					<li><a href="?lang=fr"><spring:message code="language.french"/></a></li>
				</ul>
			</nav>
		</div>
	</div>
	...
	<h3 class="text-center">
		<span class="blue">We</span><span class="white">lov</span><span
			class="red">amsterdam</span>
	</h3>
	<!-- Thumbnails -->
	...
	<div class="footer text-center">
		<p>DK <spring:message code="welcome.user" arguments="Djory,Krache"/></p>
	</div>
